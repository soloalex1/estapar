  ...
  return (
    <>
      <div className="hidden md:flex items-center justify-end gap-4">
        ...
        <button className="inline-flex items-center gap-2" onClick={logout}>
      ...
      {isMobileOpen && (
        <ul className="absolute z-10 top-full right-0 mt-2 h-fit w-full bg-white border border-gray-200 rounded shadow-lg py-2">
