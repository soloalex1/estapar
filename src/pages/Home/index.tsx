  ...
  return (
    <main className="w-dvw h-fit max-h-dvh">
      ...
      <section
        ...
        className={`w-full h-full mt-16 lg:mt-20 flex flex-col items-start justify-start gap-4 pl-22 pr-4 ${isSidebarCollapsed ? 'md:px-24' : 'md:pl-72 md:pr-16'} transition-all duration-300`}
      >
