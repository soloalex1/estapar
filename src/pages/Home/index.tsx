...
const HomePage = () => {
  ...
  return (
    <section
      ...
      className={`w-full h-full mt-16 lg:mt-20 flex flex-col items-start justify-start gap-4 pl-22 pr-4 ${isCollapsed ? 'md:px-24' : 'md:pl-72 md:pr-16'} transition-all duration-300`}
    >
      <h1 id="home-title" className="text-3xl font-bold text-black text-left">
        Bem-vindo ao portal Estapar B2B
      </h1>
      <p
        className={`text-md ${isCollapsed ? 'md:max-w-2/3' : 'md:max-w-3/4 '} text-gray-500 text-left transition-all duration-300`}
      >
